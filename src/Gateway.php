...
class Gateway extends AbstractGateway
{
    ...
    public function __construct(
        ...
        Braintree_Gateway $braintree = null
    )
    {
    ...
    {
        return $this->createRequest('\Corals\Modules\Payment\Braintree\Message\FindCustomerRequest',
            array('customerId' => $id));
    }
    ...
    {
        return $this->createRequest('\Corals\Modules\Payment\Braintree\Message\CreateMerchantAccountRequest',
            $parameters);
    }
    ...
    {
        return $this->createRequest('\Corals\Modules\Payment\Braintree\Message\UpdateMerchantAccountRequest',
            $parameters);
    }
    ...
    {
        return $this->createRequest('\Corals\Modules\Payment\Braintree\Message\CreatePaymentMethodRequest',
            $parameters);
    }
    ...
    {
        return $this->createRequest('\Corals\Modules\Payment\Braintree\Message\DeletePaymentMethodRequest',
            $parameters);
    }
    ...
    {
        return $this->createRequest('\Corals\Modules\Payment\Braintree\Message\UpdatePaymentMethodRequest',
            $parameters);
    }
    ...
    {
        return $this->createRequest('\Corals\Modules\Payment\Braintree\Message\CancelSubscriptionRequest',
...
//            "trialPeriod" => $plan->trial_period,
    ...
    {
        return $this->createRequest('\Corals\Modules\Payment\Braintree\Message\UpdateSubscriptionRequest', $parameters);
    }

    public function prepareSubscriptionCancellationParameters(User $user, Subscription $current_subscription)
    {
        return ['id' => $current_subscription->subscription_reference];
    }
